...
<div
      ...
      >
        ...
        >
          <h3>Distributing The Medicine</h3>
        </div>

        <div className="section d-flex flex-column justify-content-center align-items-center" style={{height:'53vh'}}>
                       <h4 className="text-center fw-bold">Enter Medicine ID</h4>
                       <div className="input_file d-flex align-items-center">
                       <input className=" my-3 bg-secondary rounded-3 p-1" type="number" onChange={handlerChangeID} />
                       <input className="d-none" type="file" />

                       </div>
                       <Button onClick={handlerSubmitDistribute} className="row col-3">Distribute Medicine</Button>
                </div>
